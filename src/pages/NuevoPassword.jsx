...
const NuevoPassword = () => {
  ...
  const handleSubmit = async e => {
    ...
    // SI todo sale bien, hacer la peticion hacia el endpoint
    try {
  ...
  return (
    <>
      ...
      {msg && <Alerta alerta={alerta} />}
       ...
       {/* SI el token es valido true debemos de mostrar el formulario */}
      {tokenValido && (
      ...
      {passwordModificado && (<Link className='block text-center my-5 text-slate-500 uppercase text-sm' 
